...
class ExpenseInput extends Component {
    ...
    render() {
        ...
        const expenseNameError = isFieldTouched('expenseName') && getFieldError('expenseName');
        const expenseCostError = isFieldTouched('expenseCost') && getFieldError('expenseCost');
                ...
                <Form layout="vertical" onSubmit={this.handleSubmit}>
                    <FormItem
                        ...
                        {getFieldDecorator('expenseName', {
                            ...
                            <Input prefix={<Icon type="idcard" style={{ fontSize: 13 }} />} placeholder="Expense name" />
                        )}
                    </FormItem>
                    ...
                    <FormItem
                        ...
                        {getFieldDecorator('expenseCost', {
                            ...
                            <Input prefix={<Icon type="wallet" style={{ fontSize: 13 }} />} type="number" placeholder="Expense cost" />
                        )}
                    </FormItem>
